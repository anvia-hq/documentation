...
The runtime never applies DDL. Include the generated file in `drizzle.config.ts`, generate a migration, and deploy it before the application. See the [source changelog](https://github.com/anvia-hq/anvia/blob/v1-rc3/packages/memory-drizzle/CHANGELOG.md) when refreshing generated schema.
