...
The package is ESM, includes declarations, uses the official Mistral SDK, and should use a version compatible with its declared `@anvia/core` dependency range. OCR byte uploads and server credentials make it a server-side integration.
