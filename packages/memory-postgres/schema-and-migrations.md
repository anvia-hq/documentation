...
Re-generate and diff DDL after package upgrades. The [source changelog](https://github.com/anvia-hq/anvia/blob/staging/packages/memory-postgres/CHANGELOG.md) records contract changes, but your deployment owns rollout and rollback.
