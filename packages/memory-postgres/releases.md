...
See the complete [source changelog](https://github.com/anvia-hq/anvia/blob/staging/packages/memory-postgres/CHANGELOG.md). Before upgrading, compare its changes with your generated DDL and concurrency tests.
