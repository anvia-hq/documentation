...
- The unit of work can be based on [`05_pipelines/08-research-pipeline.ts`](https://github.com/anvia-hq/anvia/blob/main/cookbook/05_pipelines/08-research-pipeline.ts).
